...
import os
import polars as pl
from alphalab.data._utils import NoSuchKeyError
...
class TestUploadAppInitialization:
    ...
    @patch('alphalab.data.pipeline.app.DataPublishers')
    @patch('alphalab.data.pipeline.app.DataCollectors')
    @patch('alphalab.data.pipeline.app.CIKResolver')
    @patch('alphalab.data.pipeline.app.RateLimiter')
    @patch('alphalab.data.pipeline.app.TradingCalendar')
    @patch('alphalab.data.pipeline.app.UniverseManager')
    @patch('alphalab.data.pipeline.app.SecurityMaster')
    @patch('alphalab.data.pipeline.app.Ticks')
    @patch('alphalab.data.pipeline.app.Validator')
    @patch('alphalab.data.pipeline.app.setup_logger')
    @patch('alphalab.data.pipeline.app.StorageClient')
...
class TestUploadAppHandlerFactories:
    ...
    def test_get_daily_ticks_handler_creates_handler(self):
        ...
        with patch('alphalab.data.price.handler.DailyTicksHandler') as MockHandler:
    ...
    def test_get_fundamental_handler_creates_handler(self):
        ...
        with patch('alphalab.data.fundamental.handler.FundamentalHandler') as MockHandler:
    ...
    def test_get_top3000_handler_creates_handler(self):
        ...
        with patch('alphalab.data.master.handler.Top3000Handler') as MockHandler:
