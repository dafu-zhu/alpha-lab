...
class TestTicksDataCollector:
    ...
    def test_initialization(self):
        ...
        from alphalab.data.pipeline import TicksDataCollector
    ...
    def test_collect_daily_ticks_year_uses_alpaca(self):
        ...
        from alphalab.data.pipeline import TicksDataCollector
        from alphalab.models import TickDataPoint
...
class TestFundamentalDataCollector:
    ...
    def test_initialization_with_logger(self):
        ...
        from alphalab.data.pipeline import FundamentalDataCollector
    ...
    @patch('alphalab.data.pipeline.collectors.setup_logger')
    ...
    def test_get_or_create_fundamental_cache(self):
        ...
        from alphalab.data.pipeline import collectors as dc

        mock_logger = Mock(spec=logging.Logger)
        collector = dc.FundamentalDataCollector(logger=mock_logger, fundamental_cache_size=1)

        with patch('alphalab.data.pipeline.collectors.Fundamental') as mock_fundamental:
            f1 = Mock()
            f2 = Mock()
            f3 = Mock()
...
class TestUniverseDataCollector:
    ...
    def test_initialization_with_logger(self):
        ...
        from alphalab.data.pipeline import UniverseDataCollector
    ...
    @patch('alphalab.data.pipeline.collectors.fetch_all_stocks')
...
class TestDataCollectorsOrchestrator:
    ...
    def test_initialization_creates_specialized_collectors(self):
        ...
        from alphalab.data.pipeline import DataCollectors
...
class TestDataCollectorInheritance:
    ...
    def test_ticks_collector_inherits_datacollector(self):
        ...
        from alphalab.data.pipeline import TicksDataCollector
        from alphalab.models import DataCollector
...
class TestFundamentalDataCollectorCaching:
    ...
    def test_fundamental_cache_race_condition(self):
        ...
        with patch('alphalab.data.pipeline.collectors.Fundamental') as MockFundamental:
