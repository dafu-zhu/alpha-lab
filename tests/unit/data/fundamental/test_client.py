...
from alphalab.data.fundamental.client import extract_concept, MAPPINGS


class TestExtractConcept:
    """Test extract_concept function"""

    @patch.dict('alphalab.data.fundamental.client.MAPPINGS', {'sales': ['us-gaap:Revenues', 'us-gaap:SalesRevenueNet']})
    ...
    @patch.dict('alphalab.data.fundamental.client.MAPPINGS', {'assets': ['us-gaap:Assets']})
    ...
    @patch.dict('alphalab.data.fundamental.client.MAPPINGS', {})
    ...
    @patch.dict('alphalab.data.fundamental.client.MAPPINGS', {'sales': 'us-gaap:Revenues'})  # String instead of list
    ...
    @patch.dict('alphalab.data.fundamental.client.MAPPINGS', {'sales': ['InvalidTag']})
...
class TestSECClient:
    ...
    def test_fetch_company_facts_success(self):
        ...
        from alphalab.data.fundamental.client import SECClient
...
class TestFundamentalExtractor:
    ...
    def test_extract_field_success(self):
        ...
        from alphalab.data.fundamental.client import FundamentalExtractor
    ...
    @patch.dict('alphalab.data.fundamental.client.MAPPINGS', {'sales': ['us-gaap:Revenues']})
    ...
    @patch.dict('alphalab.data.fundamental.client.MAPPINGS', {'sales': ['us-gaap:Revenues', 'custom:CompanyRevenue']})
    ...
    @patch.dict('alphalab.data.fundamental.client.MAPPINGS', {'sales': ['us-gaap:Rev1', 'us-gaap:Rev2']})
    ...
    @patch.dict('alphalab.data.fundamental.client.MAPPINGS', {'sales': ['us-gaap:Revenues:Extra']})
...
class TestDurationConcepts:
    ...
    def test_duration_concepts_exists(self):
        ...
        from alphalab.data.fundamental.client import DURATION_CONCEPTS
...
class TestHeaderConfiguration:
    ...
    def test_header_from_env(self):
        ...
        import importlib
        import alphalab.data.fundamental.client as fundamental_module
        importlib.reload(fundamental_module)

        from alphalab.data.fundamental.client import HEADER
...
class TestSECClientRateLimiter:
    ...
    @patch('alphalab.data.fundamental.client.requests.get')
...
class TestFundamentalExtractorEdgeCases:
    ...
    def test_extract_concept_raises_for_undefined_concept(self):
        ...
        from alphalab.data.fundamental.client import extract_concept
