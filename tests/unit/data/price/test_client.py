...
MOCK_LOGGER_PATH = 'alphalab.data.price.client.LoggerFactory'
MOCK_REQUESTS_GET_PATH = 'alphalab.data.price.client.requests.get'
...
class TestRecentDailyTicks:
    ...
    def test_future_end_date_clamps_to_yesterday(self, mock_get, mock_logger_factory):
        ...
        with patch('alphalab.data.price.client.dt.datetime', FixedDateTime):
            ticks = Ticks()
            result = ticks.recent_daily_ticks(['AAPL'], '2024-06-30', window=90)
