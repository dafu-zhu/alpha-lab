...
import io
from alphalab.data.universe.current import is_common_stock, fetch_all_stocks
...
File Creation Time: 0101202400:00"""
    ...
    @patch('alphalab.data.universe.current.FTP')
    ...
    @patch('alphalab.data.universe.current.pd.read_csv')
