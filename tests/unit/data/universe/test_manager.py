...
class TestUniverseManager:
    ...
    @patch('alphalab.data.universe.manager.Ticks')
    @patch('alphalab.data.universe.manager.SecurityMaster')
    @patch('alphalab.data.universe.manager.setup_logger')
    ...
    @patch('alphalab.data.universe.manager.SecurityMaster')
    @patch('alphalab.data.universe.manager.setup_logger')
    @patch('alphalab.data.universe.manager.fetch_all_stocks')
    ...
    @patch('alphalab.data.universe.manager.SecurityMaster')
    @patch('alphalab.data.universe.manager.setup_logger')
    @patch('alphalab.data.universe.manager.get_hist_universe_local')
