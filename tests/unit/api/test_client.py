...
@pytest.fixture
def client(test_data_dir: Path) -> AlphaLabClient:
...
class TestClientBasics:
    ...
    def test_client_creation(self, test_data_dir: Path) -> None:
        ...
        client = AlphaLabClient(data_path=str(test_data_dir))
        assert client is not None

    def test_client_context_manager(self, test_data_dir: Path) -> None:
        """Test client as context manager."""
        with AlphaLabClient(data_path=str(test_data_dir)) as client:
            assert client is not None
...
class TestSecurityLookup:
    ...
    def test_lookup_symbol(self, client: AlphaLabClient) -> None:
        """Test looking up symbol."""
        info = client.lookup("AAPL")
        assert info is not None
        assert info.symbol == "AAPL"

    def test_lookup_missing(self, client: AlphaLabClient) -> None:
...
class TestUniverse:
    ...
    def test_load_universe(self, client: AlphaLabClient) -> None:
    ...
    def test_invalid_universe(self, client: AlphaLabClient) -> None:
