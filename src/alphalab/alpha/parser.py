...
Provides alpha_eval() for parsing string expressions like:
    ...
    alpha_eval("rank(-ts_delta(close, 5))", {"close": close_df}, ops=alphalab.operators)
...
class SafeEvaluator(ast.NodeVisitor):
    ...
    def __init__(
        ...
        Args:
            ...
            ops: Module/namespace containing operator functions (e.g., alphalab.operators)
        """
...
def alpha_eval(
    ...
    Args:
        ...
        variables: Mapping of variable names to Alpha/DataFrame values
        ops: Module containing operator functions (e.g., alphalab.operators)
