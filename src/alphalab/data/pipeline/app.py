...
from alphalab.data.storage import StorageClient
from alphalab.data.pipeline import DataCollectors, DataPublishers, Validator
from alphalab.data._utils import CIKResolver, RateLimiter
from alphalab.data.price.client import Ticks
from alphalab.data.master.security_master import SecurityMaster
from alphalab.data.universe.manager import UniverseManager
...
class UploadApp:
    ...
    def _get_daily_ticks_handler(self):
        from alphalab.data.price.handler import DailyTicksHandler
    ...
    def _get_fundamental_handler(self):
        from alphalab.data.fundamental.handler import FundamentalHandler
    ...
    def _get_features_handler(self):
        from alphalab.data.features.handler import FeaturesHandler
    ...
    def _get_top3000_handler(self):
        from alphalab.data.master.handler import Top3000Handler
