...
66 pre-built data fields stored as wide matrices (Date × security_id) in Arrow IPC format at `data/features/{field}.arrow`. Use any field name directly in alpha expressions.
